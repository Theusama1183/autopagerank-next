...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-auto lg:h-screen font-[Montserrat]">
      ...
      {/* Right Panel */}
      <div className="w-full lg:w-1/2 bg-[#0070f3] text-white flex flex-col justify-center items-center text-center py-16 px-4">
        ...
        <div className="swiper w-full max-w-full py-2 lg:py-2 mb-5">
          <div className="swiper-wrapper flex items-center h-[300px]">
            <div className="swiper-slide rounded-[20px]">
              <img
          ...
          <div className="swiper-pagination mt-5 text-white" />
        </div>
